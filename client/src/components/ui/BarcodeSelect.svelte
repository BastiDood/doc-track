<script lang="ts">
    import type { Barcode } from '../../../../model/src/barcode.ts';
    export let barcodes: Barcode['code'][];
    export let code: Barcode['code'] | null = null;
</script>

<select required bind:value={code}>
    {#each barcodes as bar}
